...
var testCases = []conditionTest{
	{
		...
		obj:           &v1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "error-no-operator"}},
		...
		obj:           &v1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "test2-notexists"}},
		...
		name:          "true - test neq",
		obj:           &v1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "test1-neq"}},
		...
		obj:           &v1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "test3-lt", Finalizers: []string{"test.domain/finalizer1", "test.domain/finalizer2", "test.domain/finalizer3"}}},
		...
		obj:           &v1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "test3-gt", Finalizers: []string{"test.domain/finalizer1", "test.domain/finalizer2", "test.domain/finalizer3"}}},
		...
		obj:           &v1.Namespace{ObjectMeta: metav1.ObjectMeta{Name: "test2-contains1"}},
